...
public class Level4 extends Game.GameLevel implements Interface.Animation , Interface.LevelInformation {
...
/**
    ...
    public void initialize() {
        Ball ball = new Ball(400, 350, 4, Color.white, this.environment);
...
/**
    ...
    public void drawBackGround(DrawSurface d){
        d.setColor(new Color(150, 190, 40));
