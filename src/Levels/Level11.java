...
public class Level1 extends Game.GameLevel implements Interface.Animation , Interface.LevelInformation {
...
/**
    ...
    public void initialize() {
        Ball ball = new Ball(200, 200, 4, Color.white, this.environment);
        ball.setVelocity(2, 4);
        ball.addToGame(this);
        this.ballCounter.increase(1);
        Geometry.Rectangle recPaddle = new Geometry.Rectangle(new Geometry.Point(400, 540), 100, 30);
        Paddle paddle = new Paddle(this.gui.getKeyboardSensor(), recPaddle, 7, new Color(51, 51, 255));
...
/**
    ...
    public void drawBackGround(DrawSurface d){
        ...
        d.setColor(new Color (20,100,255));
        d.drawLine(300, 160,370, 160);
        d.drawLine(420, 160,490, 160);//425
        d.drawLine(395, 70,395, 140);
        d.drawLine(395, 180,395, 250);
        d.drawCircle(395, 160,35);
        d.drawCircle(395, 160,70);
        d.drawCircle(395, 160,105);
    }
